...
python -u inference/infer.py --config_file config/conf.yaml --model_file /public/home/qinxy/bltang/laura_gpt/ckpt/conf/best.pth --output_dir /public/home/qinxy/bltang/laura_gpt/output --default_config inference/infer.yaml