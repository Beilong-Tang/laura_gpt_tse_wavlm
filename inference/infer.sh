...
python -u inference/infer.py --config_file exp/se_wavlm/config/conf.yaml --model_file /public/home/qinxy/bltang/laura_gpt_tse/ckpt/conf/best.pth --output_dir /public/home/qinxy/bltang/laura_gpt_tse/output --default_config inference/infer.yaml