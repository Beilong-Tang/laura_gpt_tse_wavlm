...
# Infer with LJSpeech K 1024
 python -u inference/infer.py --config_file exp/tse_wavlm/config/conf_ljspeech.yaml --model_file /DKUdata/tangbl/laura_gpt_tse/exp/tse_wavlm/ckpt/conf_ljspeech/best.pth --output_dir /DKUdata/tangbl/laura_gpt_tse/output/conf_ljspeech --default_config inference/infer_no_ref_decoder_ljspeech.yaml --gpus cuda:0 cuda:1 cuda:4 cuda:5 --num_proc 4
